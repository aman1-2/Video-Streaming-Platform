...
export default function videoUpload() {
    ...
    const handleFileUpload = async function (event: ChangeEvent<HTMLInputElement>) {
        const file = event.target.files?.[0]; // ? shows if file exist then bring the file from its 0th index.
